...
import { first } from '../utility/motions';
    ...
    <div className="bg-gray-900 w-screen h-screen items-center">
      ...
      <div className="mx-auto container">
        <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between text-center md:text-left py-20">
          <div>
            ...
            <div className="mx-auto sm:w-full md:w-full mt-2">
              ...
              <div className="block mt-8">
                <a
                  href="https://twitter.com/tweetjosi"
                  className="bg-gradient-to-r from-blue-200 to-indigo-200 text-blue-500 px-6 p-2 py-4 rounded-lg m-2"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/josiahrose/"
                  className="bg-gradient-to-r from-blue-200 to-indigo-200 text-blue-500 px-6 p-2 py-4 rounded-lg m-2"
                >
          ...
          <motion.span
            className="max-w-screen-lg md:mr-32 mr-0 mt-10 md:mt-0"
            initial="initial"
            animate="enter"
            variants={first}
          >
